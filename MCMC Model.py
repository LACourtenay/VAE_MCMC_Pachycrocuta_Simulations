...
central_tendency_encoder.load_weights("central_tendency_encoder.h5")
deviation_encoder.load_weights("deviation_encoder.h5")
...
pachycrocuta = np.loadtxt("fn3_pachycrocuta.txt", delimiter = ",")
...
np.savetxt("reconstructed_pachycrocuta1.txt", pred_individuals, delimiter=",", fmt='%f')
...
pred_individuals = generator.predict(latent_individuals, verbose = False)
pred_individuals = pred_individuals.reshape(latent_individuals.shape[0], n_points * 3)
np.savetxt("reconstructed_pachycrocuta2.txt", pred_individuals, delimiter=",", fmt='%f')
...
pred_individuals = generator.predict(latent_individuals, verbose = False)
pred_individuals = pred_individuals.reshape(latent_individuals.shape[0], n_points * 3)
np.savetxt("reconstructed_pachycrocuta3.txt", pred_individuals, delimiter=",", fmt='%f')
...
pred_individuals = generator.predict(latent_individuals, verbose = False)
pred_individuals = pred_individuals.reshape(latent_individuals.shape[0], n_points * 3)
np.savetxt("reconstructed_pachycrocuta4.txt", pred_individuals, delimiter=",", fmt='%f')